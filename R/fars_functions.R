...
#' @export
#' @examples
#' fry<-fars_read_years(c(2013,2014,2015))
#' str(fry)
#' summary(fry)
#' fry[1]
...
#' @export
#' @examples
#' fsy<-fars_summarize_years(c(2013,2014,2015))
#' fsy
...
#' \dontrun{fars_map_state(2,2015)} # do not works for this year and 2013,2014 as well. Returns: nothing to draw: all regions out of bounds
#'
